...
public class TwitchPrediction {
	...
	public String getPrediction(@QueryParam("name") final String name, @QueryParam("game") final String game,
		...
		String features = name + " " + game + " " + duration + " " + daytime + " " + fps
				+ getWeatherData(new String[] { "", "" }, day, daytime);
	...
	private String formatTimestamp(Timestamp timestamp, String timeClass) {
		...
		if (timeClass.equals("Morgens"))
			hour = "06:00:00";
		if (timeClass.equals("Mittas"))
			hour = "12:00:00";
		if (timeClass.equals("Nachmittags"))
			hour = "15:00:00";
		if (timeClass.equals("Abends"))
			hour = "18:00:00";
		if (timeClass.equals("Nachts"))
			hour = "21:00:00";
